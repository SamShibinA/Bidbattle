...
//                   <img src={bid.profileimage}alt={`Bidder ${index + 1}`} className="winprofile" />
//                   <div>
...
//   useEffect(() => {
//     // Start the countdown when the first bidder is available
//     if (topBidders.length > 0 && !timerActive) {
//       setTimerActive(true);
