...
function Buy() {
  ...
  const items = [
    ...
    { id: 9, imgSrc: p8, title: "Dreamy Landscape", price: "$200.00", theme: "Modern", size: "Small", description: "The Mona Lisa is a renowned portrait by Leonardo da Vinci, famous for its enigmatic smile and captivating realism.", shippingprice: "$44" },
    { id: 10, imgSrc: p9, title: "Lost in Thought", price: "$200.00", theme: "Modern", size: "Large", description: "The painting features a woman's face, partially obscured by a vibrant mix of colors and textures. Her eyes are closed, and her lips are parted, suggesting a state of contemplation or introspection.", shippingprice: "$74" },
  ...
  const filteredAndSortedItems = items
    .filter((item) => (sizeFilter ? item.size.includes(sizeFilter) : true)) // Filter by size
    .sort((a, b) => {
      if (sortOption === "low-to-high") {
        ...
        return b.id - a.id; // Assuming latest items have higher ids
      }
      return 0;
    });
